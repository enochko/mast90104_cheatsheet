...
UMVUE: Uniformly Minimum Variance Unbiased Estimator - unbiased, sufficient and complete for $\boldsymbol\beta$, lowest var among \textbf{all} unbiased estimators.
\medskip
...
Unverified: $\sigma^2:\text{CI}=\left[\frac{(n-p)s^2}{\chi^2_{1-\alpha/2,\,n-p}}\;,\;\frac{(n-p)s^2}{\chi^2_{\alpha/2,\,n-p}}\right]$\\
\medskip
...
$R^2=1-\frac{\mathrm{SS}_{\mathrm{Res}}}{\mathrm{SS}_{\mathrm{Total}}-(\sum_iy_i)^2/n)}=1-\frac{\mathrm{SS}_{\mathrm{Res}}}{CSS}\leftarrow$bad, always decrease.\\
$R^2_{adj}=1-\frac{n-1}{n-1-k_M}(1-R_M^2)=1-\frac{n-1}{n-p}(1-R^2)=1-\frac{n-1}{n-p}\cdot\frac{\mathrm{SS}_{\mathrm{Res}}}{\mathrm{CSS}}$\\
\medskip
...
\medskip
Proof of idempotent matrix eigenvalue: $\mathbf{A}\mathbf{x}=\lambda\mathbf{x}$.
...
\medskip
Proof of idempotent matrix rank=trace: $\mathbf{A}$ idemp.$\Rightarrow$$\lambda=0\text{ or }1$.
