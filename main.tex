...
\medskip
\textbf{Hat matrix:} $\mathbf{H} = \mathbf{X}(\mathbf{X}^T \mathbf{X})^{-1}\mathbf{X}^T$, $\ \mathbf{\hat y} = \mathbf{H}\mathbf {y}$, $\mathbf{e} = (\mathbf{I}-\mathbf{H})\mathbf{y}$.\\
...
\hline
Cochran-Fisher & $y\!\sim\! N(\boldsymbol\mu,\sigma^2\mathbf{I})$, $\mathbf{A}_i$ idemp., $\sum_{i=1}^m \mathbf{A}_i=\mathbf{I}$;\\
& $\frac{1}{\sigma^2}\mathbf{y}^T \mathbf{A}_i \mathbf{y} \sim \chi^2_{r(\mathbf{A}_i),\lambda_i}$, $\lambda_i=\frac{1}{2\sigma^2}\mu^T \mathbf{A}_i \mu$, indep.; $\sum r(\mathbf{A}_i)=n$\\
\hline
\end{tabular}

\medskip
$\mathbf{y}^T \mathbf{A} \mathbf{y} \perp \mathbf{y}^T \mathbf{B} \mathbf{y} \Leftrightarrow \mathbf{A}\mathbf{V}\mathbf{B} = 0$ ($\mathbf{V}$ nonsing.).\\
$\mathbf{y}^T \mathbf{A} \mathbf{y} \perp \mathbf{C} \mathbf{y} \Leftrightarrow \mathbf{C}\mathbf{V}\mathbf{A} = 0$.\\
\medskip
