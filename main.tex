...
$f(\mathbf y; \boldsymbol\beta, \sigma^2)=(2\pi\sigma^2)^{-n/2}\exp[-(\mathbf y-\mathbf X\boldsymbol\beta)^T(\mathbf y-\mathbf X\boldsymbol\beta)/(2\sigma^2)]=\frac{1}{(2\pi\sigma^2)^{n/2} }\exp\left[-\frac{\|\mathbf y-\mathbf X\boldsymbol\beta\|^2}{2\sigma^2}\right]$.\\
...
2. Test hypotheses: $H_0:\gamma_1=\boldsymbol0$ vs. $H_1:\gamma_1\neq\boldsymbol{0}$.\\
